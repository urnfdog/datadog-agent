...
type Span struct {
	...
	MetaStruct map[string][]byte  `protobuf:"bytes,17,rep,name=meta_struct,json=metaStruct" json:"meta_struct,omitempty" msg:"meta_struct" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Span) Size() (n int) {
	...
	if len(m.MetaStruct) > 0 {
		for k, v := range m.MetaStruct {
			...
			n += mapEntrySize + 2 + sovSpan(uint64(mapEntrySize))
		}
	}
	return n
}
...
var fileDescriptorSpan = []byte{
	...
	0x10, 0xc6, 0x71, 0x93, 0x34, 0xc9, 0x26, 0xd0, 0x76, 0x45, 0xd1, 0x2a, 0x42, 0x59, 0x6b, 0x4f,
	...
	,
}
